...
const Editar = () => {
  ...
  const product = ceramicProducts.find(product => product.id === Number(params.id));
        ...
        <div className="grid md:grid-cols-5 gap-5 md:gap-10 items-start mt-8">
          <div className="md:col-span-3 flex flex-col gap-10">
            <div className="bg-white rounded-3xl p-7">
              <Input defaultValue={product.name} placeholder="Digite o nome do produto">Nome do Produto</Input>
              ...
              <div className='mt-6'>
                <TextArea defaultValue={product.description} placeholder="Digite a descrição do produto">
            ...
            <div className='mt-6 flex'>
              ...
              {priceCompare && (
                <div className='ml-4 w-full'>
                  <Input defaultValue={product.pricePromotion} placeholder='R$ 2,99'>Preço Promocional</Input>
                </div>
              )}
            </div>
